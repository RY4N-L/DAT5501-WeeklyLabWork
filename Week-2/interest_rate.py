## Function to calculate the compound interest on a savings account ##
...
def CompoundInterestCalculator(savings, annualInterestRate, years):
    ...
    for i in range (years):
        ...
        # Uncomment the following lines to see yearly savings output
        #text1 = "Your savings after " + str(i+1) + " years is " + str(savings)
        #print(text1)

    number_of_years_to_double = 72/annualInterestRate # Rule of 72 used to estimate time to double investment
